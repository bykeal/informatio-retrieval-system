...
''' Query '''
docs_file = os.path.join(os.getcwd(), 'retrievalmodel/data', 'docs.pickle')
inverted_index_file = os.path.join(
    os.getcwd(), 'retrievalmodel//data', 'inverted_index.pickle')
stopwords_file = os.path.join(os.getcwd(), 'retrievalmodel/resources', 'stopwords_en.txt')
